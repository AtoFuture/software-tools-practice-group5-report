...
![Packet Tracer 拓扑结构](./实验截图/26-packettracer-topology.png)
...
![Packet Tracer Simulation 数据包流动](./实验截图/30-packettracer-simulation-pdu.png)
...
![Ubuntu ip addr](./实验截图/13-ubuntu-ip-addr.png)
...
![Linux 用户与目录权限](./实验截图/19-linux-user-and-permission.png)
...
![Linux 环境变量与 Nginx 配置验证](./实验截图/21-linux-nginx-config-and-env.png)
...
![SCP 上传 public 目录](./实验截图/18-scp-upload-public.png)
...
![Nginx HTTP 200 OK 验证](./实验截图/22-http-nginx-200-ok.png)
